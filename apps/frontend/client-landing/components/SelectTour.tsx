    ...
    <div className="h-[460px] xs:h-[590px] xs2:h-[630px] xs3:h-[670px] sm:h-[590px] lg:h-[613px] overflow-x-hidden mt-[10px]">
      <div
        ...
        <div className="flex flex-col relative sm:flex-row-reverse sm:justify-between sm:items-end sm:static">
          ...
          <button
            className="flex items-center gap-[25px] xs:gap-[20px] pr-[25px] pl-[3px] py-[3px] xs:pl-[4px] xs:py-[4px] rounded-[60px] text-lightblue border border-lightblue absolute bottom-[-100px] ml-[10%] xs:ml-[15%] xs:text-lg xs1:pr-[35px] xs1:gap-[30px] xs2:pr-[40px] xs2:gap-[35px] xs3:ml-[80px] sm:static sm:py-5 sm:gap-2 sm:ml-0 sm:h-[50px] sm:border-0 sm:bg-[#fff]/90 sm:text-base lg:text-xl lg:pr-[20px] lg:gap-[15px] lx:h-[60px] lx:pl-[6px] lx:text-[22px] lx:pr-[30px]"
            onClick={() => router.push('/toursPage')}>
            <ArrowButtonBlue className="w-[40px] xs:w-[50px] h-[40px] xs:h-[50px] lg:w-[40px] lg:h-[40px] lx:w-[50px] lx:h-[50px] sm:w-[40px] sm:h-[40px]" />
            Выбрать Тур
          </button>
        </div>
      </div>
