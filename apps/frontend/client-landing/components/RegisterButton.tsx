  ...
  return (
    <div className="flex flex-col items-center">
      <div className="hidden">
        <Image src="/planeLine.svg" alt="line" width={100} height={100} className="hidden" />
        <Image src="/planeLineAdaptive.png" alt="line" width={300} height={100} className="" />
      </div>
      ...
      <button className="flex items-center gap-4 xl:gap-7 border border-[#D7D7D7] p-1 rounded-[30px] pr-7 text-[#489FC4] xl:pr-[50px] xl:text-xl">
        <Image src="/arrowButton.svg" alt="line" width={50} height={0} className="" />
        Зарегистрироваться
      </button>
    </div>
  );
