          ...
          <button
            ...
            className={
              selectTypeTour === elem.id
                ...
                : 'text-background py-3 px-4 bg-[radial-gradient(circle,#FFFFFF,#E8E8E8)] backdrop-blur-[50px] rounded-full w-[230px] h-[50px] sm2:w-[260px] sm2:h-[65px] sm2:text-lg sm:w-[150px] sm:h-[40px] sm:text-xs lg:w-[190px] xl:w-[250px] xl:h-[50px] xl:text-lg'
            }
            onClick={() => setSelectTypeTour(elem.id)}>
            {elem.name}
          </button>
        ))}
      </div>
