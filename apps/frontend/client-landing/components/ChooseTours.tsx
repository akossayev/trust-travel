        ...
        <div className="flex flex-col lg:flex-row gap-2 items-center lg:justify-between xl:gap-[40px] w-full">
          <div className="flex items-center gap-[80px] w-full">
            <div className="flex flex-col items-start gap-2 lg:gap-3 w-full">
              ...
              <button className="w-full h-[50px] lg:w-auto lg:h-auto xs3:h-[60px] text-dark lg:text-white lg:gap-4 text-sm xs:text-base xs3:text-lg lg:text-xl bg-white lg:bg-transparent rounded-[40px] flex items-center justify-between px-6 lg:px-0 xl:text-[22px]">
                Алматы
