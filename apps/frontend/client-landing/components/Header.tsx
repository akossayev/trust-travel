...
import BurgerMenuMobile from '../public/svg/BurgerMenuMobile';
import ArrowUpDark from '../public/svg/ArrowUpDark';
    ...
    <header className="py-5 px-[5%] flex items-center justify-between">
      ...
      <ul className="hidden lg:flex items-center gap-8 leading-[100%] text-darklight text-lg">
        ...
        <li
          ...
          {isOpenTours && (
            <ul className="text-xs lg:text-sm w-[140px] lg:w-[180px] py-2 px-2 absolute left-1/2 top-full transform -translate-x-1/2 mt-2 rounded-[30px] bg-white/50 backdrop-blur-[30px] shadow-sm border-[1px] border-[#CACACA] bg-[#fff]/40 text-[#747474]">
