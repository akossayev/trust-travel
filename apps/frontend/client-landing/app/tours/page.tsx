...
import ClassicTours from '../(landing)/_components/ClassicTours';
import CustomTours from '../(landing)/_components/CustomTours';
import TourProgramm from '../(landing)/_components/ToursProgramm';
