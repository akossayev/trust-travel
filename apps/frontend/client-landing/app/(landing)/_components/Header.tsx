  ...
  return (
    <header className="flex justify-between items-center py-5 px-8 w-full lg:px-[60px] 2xl:px-[110px] my-[20px]">
      ...
      <ul className="hidden sm:flex sm:gap-4 lg:gap-10">
        ...
        <li
          className="text-sm lg:text-xl 2xl:text-2xl cursor-pointer"
      ...
      {isOpenOffice && (
        <ul className="flex flex-col items-center gap-1 absolute left-[1240px] top-[100px] w-[220px] h-[160px] p-2 rounded-[30px] bg-white/50 backdrop-blur-[30px] shadow-sm border-[1px] border-[#CACACA] text-[#747474]">
